...
$del_topic_sql = "DELETE FROM ks_forum_category WHERE category_id = $saved_id;";
$del_topic_res = mysqli_query($mysqli, $del_topic_sql) or die(mysqli_error($mysqli));
// perform deletion from forum_posts
$del_post_sql = "DELETE FROM ks_forum_thread WHERE category_id = $saved_id;";
$del_post_res = mysqli_query($mysqli, $del_post_sql) or die(mysqli_error($mysqli));

$display_block = "<hr><h2><em>Your category has been deleted.</em></h2>";
